...
// 主题帖名
const subjectRegex = /明末|夏思源|labubu|LABUBU|泡泡玛特|Labubu|拉布布|王宁|哪吒|潘宏|潘虹|艾特|羽毛|黑神话|黑猴|余承东|余大嘴|鸿蒙|M9|m9|问界|M7|华为|m7|海狗|higo|已为你隐藏黑名单发布的内容|怎么样|假如|如果|吗|毒点|女拳|女权|小土豆|女.*pua|pua.*女|女.*觉醒|厌女|小仙女|小红书|彩礼|xxn|XXN|XxN|xXn|Xxn|xxN|ghg|xhs|董宇辉|南.*北|北.*南|华为/;

// 楼层内容关键字
const contentRegex = /明末|夏思源|余承东|余大嘴|问界|M7|华为|m7|海狗|higo|毒点|已为你隐藏黑名单发布的内容/;
