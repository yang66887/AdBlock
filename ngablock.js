...
// 主题帖名
const subjectRegex = /问界|M7|华为|m7|已为你隐藏黑名单发布的内容|怎么样|假如|如果|吗|毒点|女拳|女权|小土豆|女.*pua|pua.*女|女.*觉醒|厌女|小仙女|小红书|彩礼|xxn|XXN|XxN|xXn|Xxn|xxN|ghg|xhs|董宇辉|南.*北|北.*南|华为/;

// 楼层内容关键字
const contentRegex = /问界|M7|华为|m7|毒点|已为你隐藏黑名单发布的内容/;
